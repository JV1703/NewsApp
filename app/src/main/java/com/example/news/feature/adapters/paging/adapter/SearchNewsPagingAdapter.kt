...
class SearchNewsPagingAdapter(private val clickListener: (Article) -> Unit) :
    PagingDataAdapter<Article, SearchNewsPagingAdapter.ArticleViewHolder>(DiffUtilCallback) {
