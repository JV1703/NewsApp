...
inline fun <reified T : Fragment> launchFragmentInHiltContainer(
    ...
    val mainActivityIntent =
        Intent.makeMainActivity(ComponentName(ApplicationProvider.getApplicationContext(),
    ...
    ActivityScenario.launch<HiltTestActivity>(mainActivityIntent).onActivity { activity ->
        ...
        val fragment =
            activity.supportFragmentManager.fragmentFactory.instantiate(Preconditions.checkNotNull(T::class.java.classLoader),
                T::class.java.name)
